<!DOCTYPE html>
    ...
    <body>
        <!-- Navbar -->
                ...
                <div class="container">
                    <div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse"
                            data-target="#myNavbar"><span class="icon-bar"></span><span class="icon-bar"></span><span
                                class="icon-bar"></span></button><a class="navbar-brand" href="index.php">Home</a></div>
            ...
            <center>
                <h2>Tutorial Buat Surat Izin</h2><br><img src="img/menu.png" class="img-rounded" height="150px"><br>
                <p>1. Pada tampilan awal,
