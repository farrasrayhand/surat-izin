...
?>
        <h1>Selamat Datang <?php echo $_SESSION['username'] ?>! </h1> <a href="surat" class="btn btn-primary">Buat Surat
            Izin v.1</a><br> <a href="surat/index2.php" class="btn btn-warning">Buat Surat Izin v.2</a><br> <a
            href="about.php" class="btn btn-success">Tentang Saya</a><br> <a href="logout.php"
            class="btn btn-info">Keluar</a><br> <img src="img/2.gif" class="img-rounded" height="250px">
        <center>
            <!-- Footer -->
